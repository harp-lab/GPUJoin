...
//    cout << "| --- | --- | --- | --- | --- | --- | --- |" << endl;
    while (true) {
        ...
        time_point_begin = chrono::high_resolution_clock::now();
        thrust::sort(thrust::device, join_result, join_result + join_result_rows,
                            cmp());
        ...
        time_point_begin = chrono::high_resolution_clock::now();
        thrust::sort(thrust::device, concatenated_result, concatenated_result + concatenated_rows,
                            cmp());
        long int deduplicated_result_rows = (thrust::unique(thrust::device,
                                                            concatenated_result,
                                                            concatenated_result + concatenated_rows, thrust::equal_to<Entity()>())) - concatenated_result;
        cudaFree(result);
